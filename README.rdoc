...
A plugin to transform the default, static Redmine sidebar into a collapsible sidebar on the left side also providing some additional tabs containing project- and menu-links.
...
* Task-HITDM:  [Patch] German translation
* Task-HITDM:  [Patch] Czech and Slovak translations
...
This plugin is open-source and licensed under the "GNU General Public License v2":http://www.gnu.org/licenses/old-licenses/gpl-2.0.html (GPL). See COPYRIGHT.txt and GPL.txt for details.
